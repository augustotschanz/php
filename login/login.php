...
if($_POST){
  ...
  // Si es correcto creamos una variable session llamada nombre y que tenga el valor de tu nombre
  $_SESSION["nombre"] = "Augusto Tschanz";
  // Redireccionamos al index
  header("Location: index.php");
  }else{
    echo $msg = "Usuario o contraseña incorrectas";
  }

}
    

  // Si no es correcta la clave o el usuario mostrar en pantalla "usuario y clave incorrecta"

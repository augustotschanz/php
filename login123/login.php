...
if($_POST){
  ...
  // COMPROBAMOS QUE EL USUARIO ES ADMIN Y CLAVE SEA ADMIN123

  if($usuario == "admin" && password_verify($clave, $claveEncriptada)){
    // SI ES CORRECTA CREAMOS UNA VARIABLE DE SESION LLAMADA NOMBRE Y TENGA EL VALOR TU NOMBRE
    ...
    // SI NO ES CORRECTA LA CLAVE O EL USUARIO MOSTRAR EN LA PANTALLA "USUARIO CLAVE INCORRECTO"
